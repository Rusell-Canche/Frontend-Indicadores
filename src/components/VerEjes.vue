      ...
      <div v-for="eje in ejes" :key="eje._id?.$oid || eje._id" class="eje-card">
        <div class="eje-card-header">
          ...
          <div class="eje-info">
            ...
            <p class="eje-date">
              Creado: {{ formatDate(eje.created_at) }} | Actualizado:
              {{ formatDate(eje.updated_at) }}
            </p>
          </div>
        </div>
        <div class="eje-actions">
          <button @click="editarEje(eje)" class="btn btn-edit" title="Editar eje">
            <i class="fas fa-edit"></i>
            <span>Editar</span>
          </button>
          <button @click="eliminarEje(eje)" class="btn btn-delete" title="Eliminar eje">
