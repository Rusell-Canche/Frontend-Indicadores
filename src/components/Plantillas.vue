    ...
    <div class="main-header">
      <div class="header-content">
        <div class="header-left">
          ...
          <p class="main-subtitle">Sistema de gestión de plantillas</p>
        </div>
      </div>
    </div>
    ...
    <div class="tabs-navigation">
      <div class="tabs-container">
        <div class="tabs-header">
          <div
            class="tab"
            :class="{ active: $route.name === 'VerPlantillas' }"
            @click="$router.push({ name: 'VerPlantillas' })"
          >
            <div class="tab-icon">
              <i class="fas fa-eye"></i>
            </div>
            <div class="tab-content-text">
              <span class="tab-title">Ver plantillas</span>
              <span class="tab-description">Ver las plantillas creadas</span>
            </div>
          </div>
          <div
            class="tab"
            :class="{ active: $route.name === 'CrearPlantillas' }"
            @click="$router.push({ name: 'CrearPlantillas' })"
          >
            <div class="tab-icon">
              <i class="fas fa-plus-circle"></i>
            </div>
            <div class="tab-content-text">
              <span class="tab-title">Crear plantillas</span>
              <span class="tab-description">Crea una plantilla con los campos que desees</span>
            </div>
          </div>
...
export default {
  ...
  computed: {
    indicatorStyle() {
      ...
      const tabNames = ['VerPlantillas', 'CrearPlantillas']
