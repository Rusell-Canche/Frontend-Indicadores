    ...
    <div class="card shadow-lg border-0">
      <div class="card-header bg-primary text-white">
        <h3 class="mb-0 fw-semibold">
          <i class="bi bi-clipboard-data me-2"></i>Crear Nuevo Indicador
        </h3>
      </div>
      <div class="card-body p-4">
        <form @submit.prevent="mostrarConfirmacion">
          ...
          <div class="alert alert-info mb-4">
            <i class="bi bi-info-circle-fill me-2"></i>Los campos marcados con
            <span class="text-danger">*</span> son obligatorios
          </div>

          <!-- NOMBRE DEL INDICADOR -->
          <div class="mb-4">
            <label for="nombre-indicador" class="form-label fw-medium"
              >Nombre del Indicador <span class="text-danger">*</span></label
            >
            <input
              type="text"
              id="nombre-indicador"
          ...
          <div class="mb-4">
            <label for="proyecto" class="form-label fw-medium"
              >Seleccione Proyecto <span class="text-danger">*</span></label
            >
            <div class="input-group">
              <span class="input-group-text"><i class="bi bi-folder"></i></span>
              <select
                id="proyecto"
                v-model="nuevoIndicador.proyecto"
          ...
          <div class="d-flex justify-content-end gap-3 mt-5">
            ...
            <button type="submit" class="btn btn-primary btn-lg" :disabled="guardando">
              ...
              <template v-else> <i class="bi bi-save-fill me-2"></i>Guardar Indicador </template>
            </button>
          </div>
        </form>
      </div>
