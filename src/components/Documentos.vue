    ...
    <div class="main-header">
      <div class="header-content">
        <div class="header-left">
          ...
          <p class="main-subtitle">Sistema de gestión de documentos</p>
        </div>
      </div>
    </div>
    ...
    <div class="tabs-navigation">
      <div class="tabs-container">
        <div class="tabs-header">
          <div
            class="tab"
            :class="{ active: $route.name === 'CrearDocumentos' }"
            @click="$router.push({ name: 'CrearDocumentos' })"
          >
            <div class="tab-icon">
              <i class="fas fa-folder-open"></i>
            </div>
            <div class="tab-content-text">
              <span class="tab-title">Crear Documento</span>
              <span class="tab-description"
                >Crea un documento utilizando una plantilla como base</span
              >
            </div>
          </div>
          <div
            class="tab"
            :class="{ active: $route.name === 'VerDocumentos' }"
            @click="$router.push({ name: 'VerDocumentos' })"
          >
            <div class="tab-icon">
              <i class="fas fa-folder-open"></i>
            </div>
            <div class="tab-content-text">
              <span class="tab-title">Ver Documento</span>
              <span class="tab-description">Visualiza los documentos que se han creado</span>
            </div>
          </div>
...
export default {
  ...
  computed: {
    indicatorStyle() {
      ...
      const tabNames = ['CrearDocumentos', 'VerDocumentos']
